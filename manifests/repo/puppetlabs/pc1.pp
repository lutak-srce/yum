  ...
  case $::operatingsystemrelease {
    ...
    /^5.*/: {
      package { 'puppetlabs-release-pc1' :
        ...
        provider => 'rpm',
        source   => 'http://yum.puppetlabs.com/el/5/PC1/x86_64/puppetlabs-release-pc1-1.0.0-2.el5.noarch.rpm',
      }
    }
    /^6.*/: {
      package { 'puppetlabs-release-pc1' :
        ...
        provider => 'rpm',
        source   => 'http://yum.puppetlabs.com/el/6/PC1/x86_64/puppetlabs-release-pc1-1.0.0-2.el6.noarch.rpm',
      }
    }
    /^7.*/: {
      package { 'puppetlabs-release-pc1' :
        ...
        provider => 'rpm',
        source   => 'http://yum.puppetlabs.com/el/7/PC1/x86_64/puppetlabs-release-pc1-1.0.0-2.el7.noarch.rpm',
      }
    }
  }
}
